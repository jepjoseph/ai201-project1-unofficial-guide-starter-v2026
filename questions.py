...
QUESTIONS = [
    ...
    {
        "question":
            "Why should students complete the CS 210 labs even though they are only 10% of the grade?",
    ...
    {
        "question":
            "Which campus shuttle stop may be skipped when the driver is behind schedule?",
